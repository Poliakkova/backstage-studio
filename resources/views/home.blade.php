...
@section('content')
    ...
    <section class="block2">
        <div class="container">
            <div class="block2-content">
                <img class="block2-logo" src="{{ asset('../img/big-logo.svg') }}" alt="Логотип">
            ...
            <div class="block2-icons">
                <div class="icon-block">
                    <img src="{{ asset('../img/help-icon.png') }}" alt="Помощь">
                    <p>Консультации с мастером</p>
                </div>
                <div class="icon-block">
                    <img src="{{ asset('../img/quality-icon.png') }}" alt="Качество">
                    <p>Гарантия качества и безопасности</p>
                </div>
                <div class="icon-block">
                    <img src="{{ asset('../img/tea-icon.png') }}" alt="Чай">
                    <p>Чай, кофе</p>
                </div>
                <div class="icon-block">
                    <img src="{{ asset('../img/wifi-icon.png') }}" alt="Вай-фай">
                    <p>wi-fi, TV</p>
                </div>
            </div>
        </div>
    ...
    <section class="block4">
        <div class="container">
            ...
            <div class="gallery">
                <div class="cols">
                    <a class="popup-link" href="#image"><img src="{{ asset('../img/works/3.png') }}" alt="Тату дракон"></a>
                    <a class="popup-link" href="#image2"><img src="{{ asset('../img/works/7.png') }}" alt="Тату цветы"></a>
                </div>
                <div class="cols">
                    <a class="popup-link" href="#image3"><img src="{{ asset('../img/works/4.png') }}" alt="Тату реализм"></a>
                        <a class="popup-link" href="#image4"><img src="{{ asset('../img/works/2.png') }}" alt="Тату орнамент"></a>
                </div>
                <div class="cols">
                    <a class="popup-link" href="#image5"><img src="{{ asset('../img/works/6.png') }}" alt="Тату лайнворк"></a>
                        <a class="popup-link" href="#image6"><img src="{{ asset('../img/works/1.png') }}" alt="Тату рукав"></a>
                </div>
                <div class="cols">
                    <a class="popup-link" href="#image7"><img src="{{ asset('../img/works/8.png') }}" alt="Цветная тату"></a>
                        <a class="popup-link" href="#image8"><img src="{{ asset('../img/works/5.png') }}" alt="Тату графика"></a>
                </div>
            </div>
            <a class="more-button" href="portfolio">Посмотреть больше ></a>
            <img src="{{ asset('../img/divider.svg') }}" alt="Узор" class="divider">
        </div>
    </section>
    ...
    <div id="image2" class="popup">
        <div class="popup-body">
            <div class="popup-content popup-content-image">
                <a href="#" class="popup-close close-popup" ></a>
                <div class="popup-image">
                    <img src="{{ asset('../img/works/7.png') }}" alt="">
                </div>
            </div>
        </div>
    </div>
    <div id="image3" class="popup">
        <div class="popup-body">
            <div class="popup-content popup-content-image">
                <a href="#" class="popup-close close-popup" ></a>
                <div class="popup-image">
                    <img src="{{ asset('../img/works/4.png') }}" alt="">
                </div>
            </div>
        </div>
    </div>
    ...
    <div id="image5" class="popup">
        <div class="popup-body">
            <div class="popup-content popup-content-image">
                <a href="#" class="popup-close close-popup" ></a>
                <div class="popup-image">
                    <img src="{{ asset('../img/works/6.png') }}" alt="">
                </div>
            </div>
        </div>
    </div>
    ...
    <div id="image7" class="popup">
        <div class="popup-body">
            <div class="popup-content popup-content-image">
                <a href="#" class="popup-close close-popup" ></a>
                <div class="popup-image">
                    <img src="{{ asset('../img/works/8.png') }}" alt="">
                </div>
            </div>
        </div>
    </div>
    <div id="image8" class="popup">
        <div class="popup-body">
            <div class="popup-content popup-content-image">
                <a href="#" class="popup-close close-popup" ></a>
                <div class="popup-image">
                    <img src="{{ asset('../img/works/5.png') }}" alt="">
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="container">
            ...
            <div class="block5-content">
                <div class="step-block">
                    <img src="{{ asset('../img/phone-icon.png') }}" alt="Звонок">
                    <h4>Запись</h4>
                ...
                <img src="{{ asset('../img/fast-forward.png') }}" alt="Дальше" class="arrow">
                <div class="step-block">
                    <img src="{{ asset('../img/consult-icon.png') }}" alt="Консультация">
                    <h4>Консультация</h4>
                ...
                <img src="{{ asset('../img/fast-forward.png') }}" alt="Дальше" class="arrow">
                <div class="step-block">
                    <img src="{{ asset('../img/tattoo-icon.png') }}" alt="Сеанс">
                    <h4>Сеанс</h4>
            ...
            <div class="slider-container">
                <div class="slider-track">
                    ...
                    <div class="slider-item">
                        <div class="user">
                            <img src="{{ asset('../img/clients/'.$comment->client->photo) }}" alt="Клиент">
                            <p>{{$comment->client->name}}</p>
                        </div>
                        <div class="comment">
                            <img class="quote1" src="{{ asset('../img/quote1.png') }}" alt="Скобка">
                            <p>{{$comment->text}}</p>
                            <img class="quote2"  src="{{ asset('../img/quote2.png') }}" alt="Скобка">
                        </div>
                    </div>
                    @endforeach
    ...
    <section class="block8">
        <div class="container">
            <div class="block8-content">
                <img class="phone-pic" src="{{ asset('../img/phone.png') }}" alt="Форма">
                <div class="offer">
                    ...
                    <img class="phone-pic-small" src="{{ asset('../img/phone.png') }}" alt="Форма">
                    <div class="button-group">
                        <a class="big-button popup-link" href="#popup">Консультация бесплатно</a>
