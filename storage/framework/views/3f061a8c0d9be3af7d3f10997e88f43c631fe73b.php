...
<head>
    ...
    <link rel="icon" href="<?php echo e(asset('../img/browse-icon.png')); ?>">
    ...
    <header id="header" class="header lock-padding">
        <div class="container">
            <div class="header-body">
                <a class="logo" href="<?php echo e(route('home')); ?>"><img src="<?php echo e(asset('../img/logo.svg')); ?>" alt="Логотип" ></a>
                <div class="burger">
                    <span></span>
                </div>
    ...
    <div id="popup" class="popup">
        <div class="popup-body">
            <div class="popup-content">
                ...
                <form class="form" name="form" action="<?php echo e(route('contact-form')); ?>" method="post">
                    <?php echo csrf_field(); ?>
    ...
    <footer class="footer">
        <div class="container">
            <div class="footer-body">
                <a class="f-logo" href="<?php echo e(route('home')); ?>"><img src="<?php echo e(asset('../img/logo.svg')); ?>" alt="Логотип" ></a>
                <nav class="f-menu">
                    <ul class="list1">
...
<?php /**PATH C:\Bitnami\wampstack-8.0.3-0\apache2\htdocs\backstage — копия\resources\views/layout.blade.php ENDPATH**/ ?>