    ...
    <section class="contacts">
        <div class="container">
            <div class="contacts-body">
                ...
                <div class="title">
                    <img src="<?php echo e(asset('../img/phone-icon2.png')); ?>" alt="Телефон">
                    <h3>Наши номера</h3>
                </div>
                <div class="content">
                ...
                <div class="title">
                    <img src="<?php echo e(asset('../img/mail-icon.png')); ?>" alt="Почта">
                    <h3>Наша почта</h3>
                </div>
                <div class="content">
                ...
                <div class="title">
                    <img src="<?php echo e(asset('../img/map-icon.png')); ?>" alt="Карта">
                    <h3>Наш адрес</h3>
                </div>
                <div class="content">
...
<?php echo $__env->make('button', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Bitnami\wampstack-8.0.3-0\apache2\htdocs\backstage\resources\views/contacts.blade.php ENDPATH**/ ?>